...
import { save, open } from "@utils/dialog";
...
function SettingsModal({ isOpen, onClose }: SettingsModalProps) {
  ...
  const { exportConfigs, importConfigs, cleanupOldConfigs } =
    useFileConfigStore();
  ...
  const handleExportConfigs = async () => {
    try {
      ...
      toast.error(`Failed to export configs: ${formatError(error)}`);
    }
  };
  ...
  const handleImportConfigs = async () => {
    try {
      ...
      toast.error(`Failed to import configs: ${formatError(error)}`);
    }
  };
  ...
  const handleCleanupConfigs = async () => {
    try {
      ...
      toast.success("Old configurations cleaned up");
    } catch (error: unknown) {
      logger.error("Failed to cleanup configs:", error);
      toast.error(`Failed to cleanup configs: ${formatError(error)}`);
    }
  };
          ...
          <div className="card bg-base-200 shadow-md">
            <div className="card-body">
              ...
              <div className="form-control mt-4">
                ...
                <label className="label">
                  <span className="label-text-alt">
                    Font used throughout the application (not in Print views)
                  </span>
                </label>
              </div>
              ...
              <div className="alert alert-info mt-4">
                ...
                <div className="text-sm">
                  ...
                  <p>
                    Wrap Text, Column Lines, and Row Coloring options are
          ...
          <div className="card bg-base-200 shadow-md">
            <div className="card-body">
              ...
              <div className="form-control">
                ...
                <label className="label">
                  <span className="label-text-alt">
                    Template to use when opening Cell files
                  </span>
                </label>
              </div>
              ...
              <div className="form-control mt-4">
                <label className="label cursor-pointer justify-start gap-4">
                  ...
                  <div>
                    ...
                    <span className="label-text-alt block text-base-content/60">
                      Display non-Cell files in the file tree (greyed out and
                      non-clickable)
                    </span>
                  </div>
                </label>
              ...
              <div className="form-control mt-4">
                ...
                <label className="label">
                  <span className="label-text-alt">
                    Choose which parts of the Cell Grid to highlight when
              ...
              <div className="form-control">
                <label className="label cursor-pointer justify-start gap-4">
                  ...
                  <div>
                    <span className="label-text font-semibold block">
                      Print follows Cell edit
                    </span>
                    <span className="label-text-alt block text-base-content/60">
                      Automatically scroll Print view to show the element being
                      edited from Cell
                    </span>
                  </div>
                </label>
              ...
              <div className="form-control mt-4">
                <label className="label cursor-pointer justify-start gap-4">
                  ...
                  <div>
                    <span className="label-text font-semibold block">
                      Cell follows Print edit
                    </span>
                    <span className="label-text-alt block text-base-content/60">
                      Automatically scroll Cell view to show the row being
                      edited from Print
                    </span>
                  </div>
                </label>
            ...
            <div className="card-body">
                ...
                <div className="form-control mt-4">
                  ...
                  <div className="flex items-center gap-4">
                    <input
                      ...
                      onChange={(e) =>
                        setAutosaveIntervalSeconds(Number(e.target.value))
                      }
                  ...
                  <label className="label">
                    <span className="label-text-alt">
                      Time to wait after last edit before autosaving (5-300
                      seconds)
                    </span>
                  </label>
              ...
              <div className="alert alert-info mt-4">
                ...
                <div className="text-sm">
                  ...
                  <p>
                    After you confirm a cell edit, the autosave timer starts. If
                    you make another edit before the timer expires, it resets.
                    When the timer reaches zero, your changes are automatically
                    saved.
                  </p>
                </div>
              </div>
                ...
                <>
                  <div className="form-control mt-4">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setAutocompleteMinChars(Number(e.target.value))
                      }
                      className="input input-bordered w-full max-w-xs"
                    />
                    <label className="label">
                      <span className="label-text-alt">
                        Minimum characters to type before showing suggestions (0
                        shows all values)
                      </span>
                    </label>
                  </div>
                  ...
                  <div className="form-control mt-4">
                    <label className="label cursor-pointer justify-start gap-4">
                      <input
                        ...
                        onChange={(e) =>
                          setAutocompleteRestrictToExisting(e.target.checked)
                        }
                      />
                      <div>
                        <span className="label-text font-semibold block">
                          Restrict to existing values
                        </span>
                        <span className="label-text-alt block text-base-content/60">
                  ...
                  <div className="alert alert-info mt-4">
                    ...
                    <div className="text-sm">
                      ...
                      <p>
                        When editing a cell, autocomplete shows suggestions
                        based on existing values in that column. Use Arrow
                        Up/Down to navigate, Enter/Tab to select, or Escape to
                        dismiss.
                      </p>
                    </div>
                  </div>
          ...
          <div className="card bg-base-200 shadow-md">
            <div className="card-body">
              ...
              <div className="text-sm space-y-2">
                ...
                <div className="mt-4 mb-2 font-semibold text-base-content/70">
                  Cell Selection & Editing
                </div>
                ...
                <div className="mt-4 mb-2 font-semibold text-base-content/70">
                  Arrow Key Navigation (when cell selected)
                </div>
                ...
                {/* Column Actions */}
                <div className="mt-4 mb-2 font-semibold text-base-content/70">
                  Column Actions (when Auto-Fit is enabled)
                </div>
                ...
                <div className="flex justify-between items-center py-2">
                  ...
                  <div>
                    <kbd className="kbd kbd-sm">Shift</kbd> +{" "}
                    <span className="mx-1">Drag column edge</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="card bg-base-200 shadow-md">
            <div className="card-body">
              ...
              <p className="text-base-content/70 mb-4">
                Export, import, and manage your file-specific settings (column
                widths, filters, display preferences).
              </p>
              ...
              <div className="alert alert-info mt-4">
                ...
                <div className="text-sm">
                  ...
                  <p>
                    Your settings are automatically saved per file. Export to
                    back up or share with others.
                  </p>
                </div>
              </div>
            </div>
