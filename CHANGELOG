...
These issues are being addressed in v0.0.2:

- **Large File Performance:** Files with 10,000+ rows experience lag. (Working on virtualizing this now)
- **Wrap Text bug:** Sometimes, editing a cell with text wrapping doesn't show all the text in the cell at once.

There's also a host of features currently in our Issues list that should be delivered in the next release.
