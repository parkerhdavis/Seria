...
**Right-click a row number** and select **Delete Row** to remove it. You can also select multiple rows and delete them at once. Use `Ctrl+Z` to undo if needed.
...
**Right-click a column header** and select **Delete Column** to remove it. You can also use the Column Manager (`Ctrl+M`) to manage columns. Use `Ctrl+Z` to undo if needed.
