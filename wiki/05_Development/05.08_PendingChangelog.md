...
- **PDF Export from Print Views**
    - Export Screenplay Print views to PDF with comprehensive customization options
        ...
        - **High-Quality Output**: 2x resolution for crisp text, JPEG compression at 98% quality
        - **Screenplay-Standard Formatting**: Courier font with proper margins (1.5" left, 1" right/top/bottom)
        ...
        - **Technical**: Uses isolated iframe rendering to bypass Tailwind CSS v4's oklch() color functions (not supported by html2canvas)
