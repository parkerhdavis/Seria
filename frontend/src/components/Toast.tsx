 ...
 * Uses DaisyUI alert components with animations for enter/exit.
 */
    ...
    return (
        <div className="toast toast-end toast-bottom z-[10000] mb-4 mr-4">
            {toasts.map((toast) => (
                <div
                    key={toast.id}
                    className={`alert ${alertClasses[toast.type]} shadow-lg animate-in slide-in-from-right duration-300 max-w-sm`}
                >
